...
// formatWeight is used by EmergencyCardPreview via import; keep it exported
export { formatWeight };
...
export function buildAlerts(card: EmergencyCardData): AlertItem[] {
...
export default function EmergencyCard({ card, resolvePhotoUrl }: Props) {
